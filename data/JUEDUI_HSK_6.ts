export const hsk_list = [
  ...
  { slNo: 1104, hanzi: "框架 (相框)", pinyin: "kuàng jià", meaning: "The wooden FRAME is broken now | The Door FRAME is broken | This window FRAME is made with steel and not wood | ReactJS is a famous JavaScript FRAMEWORK | (The PHOTO FRAME was broken | This new PHOTO FRAME looks really beautiful)" },
  { slNo: 1105, hanzi: "况且 (再说)", pinyin: "kuàng qiě", meaning: "Let's not go swimming today, the weather isn't great, BESIDES/MOREOVER/それに I am also a bit tired" },
  { slNo: 1106, hanzi: "矿产 (矿物)", pinyin: "kuàng chǎn", meaning: "China is rich in MINERALs including gold, iron, coal, diamonds etc | (原神 In Genshin you have to mine and collect your own MINERALs, like 水晶, 铁矿 etc, and make your own weapons)" },
  { slNo: 1107, hanzi: "亏待", pinyin: "kuī dài", meaning: "In our company Boss do not TREAT anyone UNFAIRLY all our salary and compensations are same | Don't MISTREAT him/TREAT him UNFAIRLY just because he didn't have any educational background" },
  { slNo: 1108, hanzi: "亏损 (赤字) (盈利)", pinyin: "kuī sǔn (yíng yú)", meaning: "There was a FINANCIAL LOSS this year | The FINANCIAL LOSS this season is really big  | (We had a big PROFIT this year which compensated our FINANCIAL LOSS last year)" },
  { slNo: 1109, hanzi: "捆绑 (绑住) (解开)", pinyin: "kǔn bǎng", meaning: "(性感) They will kidnap the girl and then BIND her with a rope | (原神) 丘丘人 abducted 萤 and BOUND her with ropes which she could not UNTIE | (We can't UNTIE this rope)" },
  { slNo: 1110, hanzi: "扩充 (扩大/扩张)", pinyin: "kuò chōng", meaning: "(to expand/enlarge in quantity X to expand/enlarge physically) | Our company is planning to ENLARGE/EXPAND (in quantity) the workforce to make more products to ENLARGE/EXPAND production | (We are planning to ENLARGE/EXPAND our Kingdom)" },
  { slNo: 1111, hanzi: "扩散 (流传) (传播)", pinyin: "kuò sàn", meaning: "The food color that fell in the bowl of water quickly SPREAD all over the bowl | If you don't treat your wound quickly the poison in your wound can SPREAD and make a bigger wound | (The rumour SPREAD very fast | We should SPREAD (sth intentionally) knowledge/awareness about this)" },
  { slNo: 1112, hanzi: "(扩大/扩张) (扩充)", pinyin: "kuò zhāng", meaning: "(to expand/enlarge physically X to expand/enlarge in quantity) | We are planning to ENLARGE/EXPAND our Kingdom | (Our company is planning to ENLARGE/EXPAND (in quantity) the workforce to make more products to ENLARGE/EXPAND production)" },
  { slNo: 1113, hanzi: "喇叭 (按响 -喇叭)", pinyin: "lǎ ba", meaning: "In Singapore you won't hear any HORN sounds that an example of a sophisticated society | Don't ring the HORN unless really necessary" },
  { slNo: 1114, hanzi: "蜡烛 (火烛)", pinyin: "là zhú", meaning: "I nee a CANDLE to walk through the cave | It's your birthday let's blow our these CANDLEs | In Diwali we ALWAYS/THROUGHOUT HISTORY buy many colorful CANDLEs and light up our whole house with it" },
  { slNo: 1115, hanzi: "啦", pinyin: "la", meaning: "Don't worry LA I got this | Okay LA don't be angry" },
  { slNo: 1116, hanzi: "来历 (来历不明)", pinyin: "lái lì", meaning: "He is an OP Swordsman with unknown ORIGIN | This antique has a long history and its ORIGIN is very interesting | His ORIGIN is not known to us | Where did she come from? unknown ORIGIN" },
  { slNo: 1117, hanzi: "来源 (根源)", pinyin: "lái yuán", meaning: "The SOURCE/ROOT of her power is the 冰火之石 | Don't jump to conclusion before knowing the ROOT cause of it" },
  { slNo: 1118, hanzi: "栏目 (...栏目)", pinyin: "lán mù", meaning: "(column or section in a publication) | Let's read the Sports SECTION of this newspaper | I am not interested in the News Section in this newspaper | In Kinokuniya go to the Chinese SECTION to find this book | I am in the Romance Novel SECTION in Kinokuniya" },
  { slNo: 1119, hanzi: "懒惰 (勤奋)", pinyin: "lǎn duò", meaning: "He is a LAZY/IDLE person | (田中くん) Tanaka-kun is LAZY/IDLE but Oota-kun is HARDWORKING" },
  { slNo: 1120, hanzi: "狼狈 (尴尬)", pinyin: "láng bèi", meaning: "(embarrassing situation X embarrassing) | I was in an EMBARRASSING and AWKWARD SITUTAION | He saved me from the EMBARRASSING and AWKWARD SITUATION | There was an EMBARRASSING and AWKWARD silence in the room" },
  { slNo: 1121, hanzi: "狼吞虎咽 (地...吃)", pinyin: "láng tūn hǔ yàn", meaning: "(GGS) 我不饿, 你不饿 那为什么 you are DEVOUR-ing LIKE a WOLF GULP and TIGEr GULP/DEVOUR-ing RAVENOUSLY | I didn't eat for a long time so when I got food at her house I DEVOUR-ed LIKE a WOLF GULP and TIGER GULP/DEVOUR-ed RAVENOUSLY" },
  { slNo: 1122, hanzi: "捞 (捕捞) (打捞)", pinyin: "lāo", meaning: "(to recover/retrieve sth from underwater) | He FISH-ed/SCOOP-ed UP a big fish from the lake | (火ノ丸相撲 Hinomaru-tachi went in a boat to train and also CATCH lots of fishes with a net from the sea | While trying to CATCH fishes with net in the sea he caught a beautiful little cute 女の子 cutely looking at him) | (ワンピース Luffy-tachi dove underwater to SALVAGE/FISH OUT (from sea) the treasures and map from the sunken pirate ship)" },
  ...
  { slNo: 1128, hanzi: "雷达", pinyin: "léi dá", meaning: "(Dr Stone) Adrift in the sea, Senku-tachi looked at the RADAR and found some red points around them, these were actually fishes which they detected and caught with the help of RADAR | A big threat was coming to them and they can detect its location with the help of Senku's RADAR | Everyone looked at the RADAR closely" },
  { slNo: 1129, hanzi: "类似 (相似) (相反)", pinyin: "lèi sì", meaning: "We both are SIMILAR  | The taste of 咖啡 and 茶 are mostly SIMILAR | (入間くん) Kirio Senpai always thought Iruma-kun and him are SIMILAR but finally he realized they are totally OPPOSITE, Iruma-kun is his 天敌" },
  { slNo: 1130, hanzi: "冷酷 (酷)", pinyin: "lěng kù", meaning: "(HunterXHunter) Sometimes Killua can be scarily COLD-BLOODED/RUTHLESS | Illumi Zoldyck and Chrollo Lucilfer both are COLD-BLOODED | (GGS Lao Han is very COOL)" },
  { slNo: 1131, hanzi: "冷却 (降温)", pinyin: "lěng què", meaning: "The PC needs to COOL OFF/COOL DOWN, it's really hot | The curry is hot, let's wait for it to COOL DOWN before we can eat | (Your body TEMPERATURE has LOWER-ed now | Today TEMPERATURE has LOWER-ed a little | The TEMPERATURE of the hot curry is LOWER-ed now, we can eat)" },
  { slNo: 1132, hanzi: "冷落", pinyin: "lěng luò", meaning: "(ホリミヤ) Everyone used to TREAT Miyamura COLDLY when he was in 初中 | Don't TREAT her COLDLY" },
  { slNo: 1133, hanzi: "愣住", pinyin: "lèng zhù", meaning: "(GGS) Why are you SPEECHLESS/STUNNED/FROZEN 快走, we are not used to seeing 老大 play with kitten" },
  { slNo: 1134, hanzi: "(黄昏) (凌晨) (清晨/黎明)", pinyin: "(huáng hūn) (líng chén) (qīng chén/lí míng)", meaning: "DAWN/DAYBREAK is beautiful and healthy if you can wake up | Do not stay awake in WEE-HOURS | (ベイポップ) We play till TWILLIGHT 体 疲れ 果てるまで | TWILLIGHT is between ~6.00 pm to ~7.00pm, then comes night and then WEE-HOURS from 12.00 am to 5.00 am and then comes DAWN/DAYBREAK ~5.00 am to ~7.00 am" },
  { slNo: 1135, hanzi: "里程碑", pinyin: "lǐ chéng bēi", meaning: "This is the 7th MILESTONE I saw from Dharmanagar to Kadamtala | This is a big MILESTONE in our journey, we got shifted to SG Office" },
  { slNo: 1136, hanzi: "礼节 (礼仪)", pinyin: "lǐ jié", meaning: "My husband hired 7 teachers to teach me ETIQUETTEs for the gala/ballroom | (We have to teach our child ETIQUETTEs from early age)" },
  { slNo: 1137, hanzi: "礼尚往来", pinyin: "lǐ shàng wǎng lái", meaning: "If someone is friendly to us, we should also be friendly to them, it is RETURN POLITENESS FOR POLITENESS | When your friend shares his toys with you, you should also share yours, this is RETURN POLITENESS FOR POLITENESS | We should teach our child to RETURN POLITENESS WITH POLITENESS" },
  { slNo: 1138, hanzi: "理睬 (不理不睬)", pinyin: "lǐ cǎi", meaning: "(She did NOT PAY any HEED/ATTENTION to what I was saying | She COMPLETELY IGNORE-d what I was saying) | I wanted her to HEED/PAY ATTENTION TO my story" },
  { slNo: 1139, hanzi: "理所当然 (视为...~)", pinyin: "lǐ suǒ dāng rán", meaning: "She worked really hard, so her success and promotion is EXPECTED/NATURAL | Don't TAKE my help FOR GRANTED, when I am no longer there you will feel my importance | We TAKE our parents' love FOR GRANTED | We CONSIDER it as NATURAL/EXPECTED" },
  { slNo: 1140, hanzi: "理直气壮 (自信满满)", pinyin: "lǐ zhí qì zhuàng", meaning: "He WAS CONFIDENT and STRONG (with sufficient reason) while explaining why 消灭 Oukoku was right | He defended his views CONFIDENTLY (with fufficient reason)" },
  { slNo: 1141, hanzi: "理智 (理性) (常识)", pinyin: "lǐ zhì", meaning: "Don't lose your RATIONALITY | (He is a RATIONAL person | Let's think RATIONAL-ly) | (Don't lose your COMMON SENSE | In rainy days, when the active 电缆 falls in water, don't go near it, it's a basic COMMON SENSE)" },
  { slNo: 1142, hanzi: "粒", pinyin: "lì", meaning: "(CL for grains, rice, dal, sugar, sand etc) | She took 1 GRAIN of sand and 3 GRAINS of sugar and 5 GRAINS of rice and 7 GRAINS of dal and looked at them very closely" },
  { slNo: 1143, hanzi: "立场", pinyin: "lì chǎng", meaning: "(GGS) 我站在你的 POSITION/STANDPOINT 想, 我爸 辜负了 兄弟 but 你也站在 我的 POSITION/STANDPOINT 想 我有多么可怜 | 法官 has to maintain a neutral POSITION/STANDPOINT" },
  { slNo: 1144, hanzi: "立方 (立方体/立方形)", pinyin: "lì fāng", meaning: "The CUBE of 3 is 27 | (This CUBE is bigger than the other CUBE) | (This box is CUBE-SHAPED/CUBE-ic)" },
  { slNo: 1145, hanzi: "立交桥 (地下道/地下通道)", pinyin: "lì jiāo qiáo", meaning: "We have 3 options here, take the FLYOVER/OVERPASS or go straight by car or take the SUBWAY/UNDERPASS and walk" },
  { slNo: 1146, hanzi: "立体 (二维/三维)", pinyin: "lì tǐ", meaning: "Children made 3D/THREE-DIMENTIONAL aeroplane with paper | I made a 3D/THREE-DIMENTIONAL treasure box | This 3D/THREE-DIMENTIONAL thing is a Cube | (2D anime are mostly Japanese and 3D anime are mostly Chinese | ベイブレード Beyblade 4D)" },
  { slNo: 1147, hanzi: "立足 (立足点)", pinyin: "lì zú", meaning: "It took us 3 years to ESTABLISH our FOOTHOLD/HAVE our FOOTING in this ATS Industry | (神ひろ) Ryouma needs to ESTABLISH himself in the market of Gimul by providing the best quality to his customers | Easiest way for our company to ESTABLISH itself in the foreign market is by giving top quality service with something special | (ゴミ拾い Ivy lost her FOOTHOLD when she saw her father is planning to kill her along with Village Chief due to her ほしなし skill)" },
  { slNo: 1148, hanzi: "历代 (历朝历代) (传承)", pinyin: "lì dài", meaning: "This palace has been sturdy THROUGH many GENERATIONS | This sword has been passed down to us THROUGHOUT GENERATIONS/AGES/DYNASTIES | Her name is still famous THROUGHOUT HISTORY/THE AGES | (Grandpa and Grandma PASS-ed DOWN their experience of growing vegetables TO me)" },
  { slNo: 1149, hanzi: "历来 (来历)", pinyin: "lì lái", meaning: "(historically ALWAYS) | This village has ALWAYS been quiet and peaceful | Our city has ALWAYS been famous for its 茶 | People THROUGHOUT HISTORY/ALWAYS longed for peace and harmony) | (He is an OP Swordsman with unknown ORIGIN | This antique has a long history and its ORIGIN is very interesting | His ORIGIN is not known to us)" },
  { slNo: 1150, hanzi: "利害", pinyin: "lì hài", meaning: "There are many PROS AND CONS on choosing either one | Can you tell me the PROS AND CONS of choosing Mac and Windows" },

  { slNo: 1151, hanzi: "力所能及 (尽力/竭尽全力)", pinyin: "lì suǒ néng jí", meaning: "できる限り/ちからのかぎり I'll help you WITHIN my POWERS/to the BEST of my ABILITY | (She 全力せいっぱい DID HER BEST to defeat 若陀龙王 alone)" },
  { slNo: 1152, hanzi: "(力求) 力争 (争取) (尽力/竭尽全力)", pinyin: "lì zhēng", meaning: "Let's STRIVE TO get good results this time | Let's STRIVE/WORK HARD for reaching 黄金级 by this year | We STRIVE-d/WORK-ed HARD to win first place in the competition | (She 全力せいっぱい DID HER BEST to defeat 若陀龙王 alone)" },
  { slNo: 1153, hanzi: "力求 (力争/争取) (尽力/竭尽全力)", pinyin: "lì qiú", meaning: "Let's STRIVE TO get good results this time | Let's STRIVE/WORK HARD for reaching 黄金级 by this year | We STRIVE-d/WORK-ed HARD to win first place in the competition | (She 全力せいっぱい DID HER BEST to defeat 若陀龙王 alone)" },
  { slNo: 1154, hanzi: "例外", pinyin: "lìwài", meaning: "It's just an EXCEPTION | No one can defeat Xiu Douluo but Dragon Emperor is an EXCEPTION" },
  { slNo: 1155, hanzi: "连年", pinyin: "lián nián", meaning: "YEAR AFTER YEAR/IN SUCCESSIVE YEARS he won the Chapionship 7 times" },
  { slNo: 1156, hanzi: "连锁 (锁链)", pinyin: "lián suǒ", meaning: "FPG, They run a CHAIN of stores in Singapore | It's a CHAIN reaction | (Dragon Emperor was shackled with a big iron CHAIN | 斗罗大陆 第一魂技 灵魂 CHAIN)" },
  { slNo: 1157, hanzi: "连同 (与/和)", pinyin: "liántóng", meaning: "Karasuno went to the park TOGETHER WITH/ALONG WITH Nekoma | She came home TOGETHER WITH/ALONG WITH Dragon Emperor" },
  { slNo: 1158, hanzi: "联欢", pinyin: "lián huān", meaning: "CELEBRATION/FESTIVE GATHERING for Chinese New Year | 春节 CELEBRATION/FESTIVE GATHERING 晚会" },
  { slNo: 1159, hanzi: "联络 (联系)", pinyin: "lián luò", meaning: "They will GET IN TOUCH WITH/CONTACT me by phone | Let's STAY IN CONTACT WITH/CONTACT each other even if we return our respective homeland | There is no CONTACT/COMMUNICATION between us in last 5 years" },
  { slNo: 1160, hanzi: "联盟 (结盟)", pinyin: "lián méng", meaning: "The ALLIANCE between Galkhein and Coyolles was formed long back with help of Rishe | (We want to FORM an ALLIANCE with your Kingdom Prince Arnold Hein)" },
  { slNo: 1161, hanzi: "联想 (想起)", pinyin: "lián xiǎng", meaning: "Seeing the fluffy clouds I ASSOCIATE-d (ideas etc)/THOUGHT OF (remind-ed me of) cotton candy | Seeing Tan Sang protecting his love I THINK OF/ASSOCIATE OF Dragon Emperor protecting his love | The meaning of Lenovo Company is ASSOCIATION/MAKE THINK OF/REMIND OF" },
  { slNo: 1162, hanzi: "廉洁 (清廉) (贪污)", pinyin: "lián jié", meaning: "Xiao Ming is an INTEGRITY/UPRIGHT/HONEST boy | She found a wallet in the road with 5k, she gave it to 交番 because she knew it is the RIGHT/INTEGRITY/HONEST/UPRIGHT behaviour" },
  { slNo: 1163, hanzi: "良心", pinyin: "liáng xīn", meaning: "Don't you have any CONSCIENCE/SENSE of RIGHT and WRONG" },
  { slNo: 1164, hanzi: "晾 (晾干)", pinyin: "liàng", meaning: "The weather is nice today, we can DRY our cloths in the AIR/SUN | She wanted to DRY her cloths in the AIR/SUN but suddenly it rained" },
  { slNo: 1165, hanzi: "谅解 (了解)", pinyin: "liàng jiě", meaning: "I hope you UNDERSTAND/FORGIVE my thoughts/feelings/actions | I UNDERSTAND/FORGIVE her difficulty | We should have mutual UNDERSTANDING/FORGIVENESS | (I UNDERSTAND her situation | I UNDERSTAND this topic)" },
  { slNo: 1166, hanzi: "(开阔/广阔) 辽阔 (宽阔/宽广/宽大)", pinyin: "liáo kuò", meaning: "In the VAST/WIDE grassland of Leadale" },
  { slNo: 1167, hanzi: "列举", pinyin: "liè jǔ", meaning: "Please LIST out your favourite items | The students were asked to LIST out 10 animal names | (Give me a LIST/CHECKLIST of your favourite items)" },
  { slNo: 1168, hanzi: "(淋湿/淋雨) (雨 淋湿 我衣服)(淋雨) (淋了 一场 雨)", pinyin: "lín", meaning: "(Rain SOAK-ed my cloths) | (Do not GET SOAKED in RAIN | She GOT SOAKED in the RAIN)" },
  { slNo: 1169, hanzi: "临床 (诊所)", pinyin: "lín chuáng", meaning: "We are waiting for the CLINICAL report | You have to take this CLINICAL medicine | (I want to the CLINIC in Jurong West | 以家人之名 Li Jian Jian does not want to go to a Dental CLINIC)" },
  { slNo: 1170, hanzi: "(小气) 吝啬 (大方/慷慨)", pinyin: "lìn sè", meaning: "99分女朋友 Shen Yi is very STINGY/MEAN, he is reluctant to spend money, unwilling to give/share | (Sui An is very GENEROUS/GIVING)" },
  { slNo: 1171, hanzi: "零星 (零散)", pinyin: "líng xīng", meaning: "This issue is very INCONSISTENT (occurring in small amounts at irregular intervals)" },
  ...
  { slNo: 1178, hanzi: "领事馆 (大使馆)", pinyin: "lǐng shì guǎn (dà shǐ guǎn)", meaning: "The CONSULATE is kind of like EMBASSY | EMBASSY mostly located at the capital of the foreign country but CONSULATE can be in major cities of the foreign country | EMBASSY is higher larger and boarder in scope where CONSULATE is lower smaller and narrowed in scope primarily targeted to help the own citizens living/travelling abroad" },
  { slNo: 1179, hanzi: "领土 (领域)", pinyin: "lǐng tǔ", meaning: "(入間くん) It is my TERRITORY and they still dare to do these, Kimeta zo, ore wa kono boro kyoushitsu kara shiro ni utsuru zo | (斗罗大陆 杀神 DOMAIN | 冰火魔厨 冰元素 DOMAIN 和 火元素 DOMAIN 融合了 into SPIRIT DOMAIN" },
  { slNo: 1180, hanzi: "领悟 (领会)", pinyin: "lǐng wù", meaning: "妖神记 更何况 孙女婿 taught me how to COMPREHEND/UNDERSTAND the law of spirit power | I am not 灵宿强者 I just can COMPREHEND/UNDERSTAND two laws of spiritual power that's all" },
  { slNo: 1181, hanzi: "领先 (落后)", pinyin: "lǐng xiān", meaning: "(ハイキュー) Our team is LEAD-ing/BE IN FRONT from our opponent team by 7 points | (風が強く吹いている Akane in KazeTsuyo will definitely FALL/LAG BEHIND in the marathon | I don't want to FALL/LAG BEHIND, I want to LEAD/BE IN FRONT, kunren ni tsuki atte kure, Hinata Shoyo)" },
  { slNo: 1182, hanzi: "领袖 (首领/领导)", pinyin: "lǐng xiù", meaning: "Take me to your LEADER | LEADER we are surrounded by 雪狼 what to do | Our LEADER is 黑金级的高手" },
  { slNo: 1183, hanzi: "溜 (溜走)", pinyin: "liū", meaning: "(万界仙踪) Xingyun wanted to SLIP AWAY while An Yun and Qi Wang was battling out | (Dr Stone) Kinro wanted to SLIP AWAY from the kibishi kunren but was caught by Ginro and was dragged in" },
  { slNo: 1184, hanzi: "留恋", pinyin: "liú liàn", meaning: "I am FONDLY ATTACHED TO the scenery of my hometown and will BE really RELUCTANT TO LEAVE this place and go to Singapore | I am FONLY ATTACHED TO this house and really RELUCTANT TO LEAVE this | I am FONDLY ATTACHED TO this sword and realy RELUCTANT to sell it" },
  { slNo: 1185, hanzi: "留念 (纪念品)", pinyin: "liú niàn", meaning: "Let me KEEP this picture AS A SOUVENIR/TO PRESERVE THE MEMORY/CAPTURE THE MOMENT | I should TAKE more pictures with my family having 爸爸妈妈 smiling from heart to CAPTURE THE MOMENT/PRESERVE THE MEMORY | Newly Weds TOOK a video to CAPTURE THE MOMENT/KEEP AS SOUVENIR/PRESERVE THE MEMORY | (功夫熊猫 The only SOUVENIR we collect here is bloody knuckles and broken bones)" },
  { slNo: 1186, hanzi: "留神 (小心)", pinyin: "liú shén", meaning: "Please BE CAREFUL/TAKE CARE/WATCH OUT while crossing the road | It's hot please BE CAREFUL/WATCH OUT when you eat it | It's raining outside please BE CAREFUL when you go out | The road is slippery BE CAREFUL when walking" },
  { slNo: 1187, hanzi: "流浪 (流浪者)", pinyin: "liú làng", meaning: "(I am an WANDERER love to WANDER around the world) | Rurouni Kenshin was an OP WANDERING swordsman | She WANDER-ed to a new city searching for a new work and life| There are 7 WANDERING/HOMELESS/STRAY dogs and 3 WANDERING/HOMELESS/STRAY cats" },
  { slNo: 1188, hanzi: "流露", pinyin: "liú lù", meaning: "(to reveal emotions/thoughts/feelings etc often unintentionally) | Her smile REVEAL-ed her love for me | His breath REVEAL-ed his fear | Her eyes REVEAL-ed all her feelings" },
  { slNo: 1189, hanzi: "流氓", pinyin: "liú máng", meaning: "(HunterXHunter) Hisoka is considered a THUG/RUFFIAN in HunterXHunter same as Onizuka, Gintoki as well | (妖神记) Nilie accidentally touched 胸部 of Ye Zi Ran, She slapped him and called him ***" },
  { slNo: 1190, hanzi: "流通 (循环) (流淌)", pinyin: "liú tōng", meaning: "The rumor kept CIRCULATING among students | Our products CIRCULATED in the Singapore market for a long time | The new currency and this news will be CIRCULATING in all over India very soon | (The sun rising and setting is a natural CYCLE/CIRCULATION it keeps on happening over and over | This medicine will improve your Blood CIRCULATION) | (The blood of Dragon Emperor FLOWs within her | The river of eternity FLOWs forever)" },
  { slNo: 1191, hanzi: "聋哑 (耳聋/哑巴/瞎眼)", pinyin: "lóng yǎ", meaning: "(聲の形) Nishimiya is DEAF-and-MUTE in Koe no Katachi | (I have a DEAF spirit and MUTE spirit and a BLIND spirit)" },
  { slNo: 1192, hanzi: "隆重", pinyin: "lóng zhòng", meaning: "(微微一笑很倾城) Si Si asked in wonder to 贝微微 does it have to be that GRAND/CEREMONIAL it just a job interview right but little did she know that She is going to meet 肖奈 大人 | Today is a GRAND celebration of Chinese New Year | We held a GRAND wedding ceremony" },
  { slNo: 1193, hanzi: "垄断 (公爵)", pinyin: "lǒng duàn", meaning: "(Dr Stone) Tsukasa-tachi MONOPOLIZE-d the source of Kiseki no Mizu | Google has MONOPOLIZE-d the market of Search Engine | (くま クマ 熊 ベアー) Yuna MONOPOLIZE-d the egg sale and didn't let Duke Cliff Koshaku eat any eggs" },
  { slNo: 1194, hanzi: "笼罩 (弥漫)", pinyin: "lǒng zhào", meaning: "The dark clouds SHROUD-ed the village | Mountain was SHROUD-ed with fogs | (万界仙踪) 神秘的 fog SHROUD-ed the valley of Tong Tian 古墓 and engulfed Xingyun, Yanran and all | (The delicious smell of her cooking FILL-ed in the Air | Do Bo's poison FILL-ed in the Air do not breathe)" },
  { slNo: 1195, hanzi: "搂抱 (拥抱/抱抱)", pinyin: "lǒu", meaning: "She HUG-ed me and cried | (ホリミヤ) Hori-san wanted Miyamura to HUG her | She cutely said HUG me | (ありふれた) Kaori is already crying, HUG her already baka Nagumo, Shizuku with a fist" },
  { slNo: 1196, hanzi: "炉灶", pinyin: "lú zào", meaning: "The KITCHEN STOVE I was using in Singapore was beautiful | Mom cooked 火锅 on the STOVE | I forgot to turn off the STOVE" },
  { slNo: 1197, hanzi: "轮船", pinyin: "lún chuán", meaning: "Titanic was an OCEAN LINER/LARGE SHIP | (爱上哥们) Pi Ano and Yang Na Na 碰到 Du Ze Feng and Du Family in an OCEAN LINER/LARGE SHIP" },
  { slNo: 1198, hanzi: "轮廓", pinyin: "lún kuò", meaning: "(ナルト) The OP Song of SILHOUETTE is sung by Kana Boon | She cut out a SILHOUETTE/OUTLINE of a bird with black paper | From Hahoke We can see the beautiful SILHOUETTE/OUTLINE of Mount Fuji-san" },
  { slNo: 1199, hanzi: "轮胎 (车胎)", pinyin: "lún tāi", meaning: "I need a new TYPE for my cycle | The TYRE of my car is very old | (My CAR TYRE is very old)" },
  { slNo: 1200, hanzi: "论坛", pinyin: "lùn tán", meaning: "If you have any questions related to Chinese you can ask in the Chinese FORUM (for discussion) | Redit is a FORUM/discussion platform | You can find commonly asked questions and their answers in our community FORUM" },
  ...
  { slNo: 1202, hanzi: "啰唆 (多嘴) (唠叨)", pinyin: "luō suo", meaning: "You are really TALKATIVE | She is a TALKATIVE girl but I like her | (His grandfather NAGs/TALKS A LOT)" },
  ...
  { slNo: 1229, hanzi: "冒充", pinyin: "mào chōng", meaning: "(to pretend to be sb/sth one is not) | She PRETENDED TO BE a police officer and asked to see my ID | This medicine PRETENDs to be effective but in reality it has no effects | He PRETENDs to be weak but he is the Strongest Douluo ever | I love anime/donghua where MC PRETENDs to be weak but is indeed OP" },
  { slNo: 1230, hanzi: "(冒犯/得罪) (触犯/违犯)", pinyin: "mào fàn", meaning: "(to offend often unintentionally X offend intentionally) | I didn't mean to OFFEND you | I accidentally OFFENDed my colleague | (He deliberately OFFENDed him | Zhao Wuji OFFENDed so many in his youth) | (He was fined for VIOLATE-ing the traffic rules)" },
  { slNo: 1231, hanzi: "茂盛", pinyin: "mào shèng", meaning: "(esp vegetation growing luxuriantly) Plants in the garden is LUSH/LUXURIANT/FLOURISHING/GREEN-ful | This forest is LUXURIANT/FLOURISHING/LUSH now after the rain" },
  { slNo: 1232, hanzi: "枚", pinyin: "méi", meaning: "(CL for small, thin and flat objects eg coin, medal, badge, button, stamp, ring etc) | I found 19 Silver medals and 7 Gold medals dropped in the valley | I found 29 silver Coins and 9 Gold Coins" },
  { slNo: 1233, hanzi: "媒介 (媒人/做媒)", pinyin: "méi jiè", meaning: "My API is just a MIDDLEMAN/INTERMEDIARY between DS API and UI | (She was the MATCHMAKER of our marriage | I'll BE THE MATCHMAKER/DO MATCHMAKING for your marriage | 妖神记 I don't want you to MATCHMAKE for me, I want to marry you)" },
  { slNo: 1234, hanzi: "美观 (好看/漂亮)", pinyin: "měi guān", meaning: "This place is really BEAUTIFUL/PLEASING TO THE EYE/VISUALLY PLEASING | The scenery of Sakura season is so BEAUTIFUL/PLEASING TO THE EYE/VISUALLY PLEASING" },
  { slNo: 1235, hanzi: "美满 (满意)", pinyin: "měi mǎn", meaning: "I am really FULFILLED AND SATISFIED with my life | (I am SATISFIED/CONTENT with my life)" },
  { slNo: 1236, hanzi: "美妙", pinyin: "mě imiào", meaning: "Her performance was absolutely WONDERFUL | Our travel experience was WONDERUL | We spent a WONDERFUL summer this year" },
  { slNo: 1237, hanzi: "萌芽 (开始萌芽) (发芽) (种子) (苗子)", pinyin: "méng yá", meaning: "Children talents started SPROUTING/BUDDING through learning more | We are lucky to be able to see the SPROUTING/BUDDING/始まり of a new era | (The 冰元素 started to SPROUT/BUD in her | The seeds have started to SPROUT/BUD in the soil) | (I have a SEED of 榕树 which will one day become the largest Banyan tree) | (冰火魔厨 Bing De you found a really good SEEDLING/SAPLING this time, let's nurture it together and make it the strongest Douluo in the world)" },
  { slNo: 1238, hanzi: "猛烈 (剧烈) (激烈)", pinyin: "měng liè", meaning: "(fierce/violent/intense often sudden X severe/intense) The wind is blowing FIERCE-ly/VIOLENT-ly/SEVERE-ly | He feels a SEVERE/FIERCE/VIOLENT headache | (Today's Earthquake had a SEVERE/INTENSE shaking | She had a SEVERE cold this time) | (ハイキュー Gomisuteba no Kessen had an INTENSE battle/competition between Nekoma and Karasuno)" },
  { slNo: 1239, hanzi: "眯", pinyin: "mī", meaning: "As their was dust and also bright sunlight, he SQUINT-ed his eyes and walked ahead | You can't see the sun without SQUINT-ing your eyes but to see the moon you don't need to" },
  { slNo: 1240, hanzi: "弥补 (补充)", pinyin: "mí bǔ", meaning: "(to complement for a deficiency) | I will work hard to COMPLEMENT/MAKE UP FOR my mistake | This humble gift is to COMPLEMENT/MAKE UP FOR your emotional damage done by my 弟子 | Their power COMPLEMENTs each other's weaknesses | (to add sth extra to make things better/to fill in what's missing | Please ADD/SUPPLEMENT more information on this | We need some extra help to SUPPLEMENT our team)" },
  { slNo: 1241, hanzi: "弥漫 (笼罩)", pinyin: "mí màn", meaning: "The delicious smell of her cooking soon FILL-ed THE Air | (斗罗大陆) Du Bo's poison soon FILL-ed THE Air all around | (万界仙踪) 神秘的 fog FILL-ed THE Air of Tong Tian 古墓 and engulfed Xingyun, Yanran and all | (The mystical fog SHROUD-ed the valley)" },
  { slNo: 1242, hanzi: "迷惑 (困惑) (疑惑)", pinyin: "mí huò", meaning: "His words made me PUZZLED | You'll BE PUZZLED if you hear his word puzzle | (You'll BE CONFUSED if you hear his word puzzle | I was initially CONFUSED after reading this question | 入間くん Iruma-kun was CONFUSED after hearing Makai no Question, yometemo nani ga itteru ka mattaku wakaranai | (I am DOUBTFUL about his words | He is full of DOUBTs)" },
  { slNo: 1243, hanzi: "迷人", pinyin: "mí rén", meaning: "Her smile is very CHARMING/ENCHANTING | She has CHARMING eyes and CHARMING voice | The scenery here is very CHARMING" },
  { slNo: 1244, hanzi: "迷信", pinyin: "mí xìn", meaning: "It's just a SUPERSTITION | Kuro Neko crossed Kalego Sensei's road and He broke glass as well before going to Shoukan Test, he felt something will be wrong, can you call it SUPERSTITION as he then later became Iruma-kun's Tsukaima" },
  { slNo: 1245, hanzi: "谜语 (谜题)", pinyin: "mí yǔ", meaning: "She told me a WORD RIDDLE/PUZZLE, the RIDDLE/PUZZLE was, Tin okkorer nam tar, jole thake jole khai, modhyer okkor chariya dile shunnye uriya jai | (She gave me lots of different PUZZLEs to solve, WORD PUZZLE, Sokudo, Rubix Cube, Scrambles etc)" },
  { slNo: 1246, hanzi: "密度 (强度)", pinyin: "mì dù", meaning: "The population DENSITY of this region is high | (The training INTENSITY of this athlete is high)" },
  { slNo: 1247, hanzi: "密封 (容器) (密封圈)", pinyin: "mì fēng", meaning: "The jar is SEAL-ed properly so that achaar doesn't get spoiled | Please SEAL the box properly | The SEAL of the jar is broken | I need few SEAL-ed CONTAINERs to carry curry and soups to office, it can be plastic or steel anything is fine | I lost the SEAL-ing rings of our Pressure Cooker" },
  { slNo: 1248, hanzi: "棉花 (棉花糖)", pinyin: "mián hua", meaning: "She used her COTTON and magical potion to treat my scar | I love to sleep on COTTON pillow only | (I want to eat COTTON candy)" },
  ...
  { slNo: 1250, hanzi: "免疫 (-力/-系统)", pinyin: "miǎn yì", meaning: "White Blood Cells are key players in our IMMUNE SYSTEM | Her IMMUNITY POWER is really strong" },
  ...
  { slNo: 1279, hanzi: "魔鬼", pinyin: "móguǐ", meaning: "(オーバーロード) Demiurge is a DEVIL/DEMON" },
  ...
  { slNo: 1295, hanzi: "难得", pinyin: "nándé", meaning: "It is a RARE chance let's make the best of it | This opportunity is really RARE | They RARE-ly get together and spend a pleasant weekend" },
